### Java 웹 애플리케이션 개발자 · QA/릴리스 엔지니어링 · AI 자동화

20년 이상 엔터프라이즈 Java, JavaScript 웹 애플리케이션을 개발·유지보수하고 **품질을 관리**해 왔습니다. 지금은 그 경험을 **AI/LLM 기반 자동화**로 확장하고 있습니다.
...
| 🛠 **QA / 릴리스 엔지니어링** | CI/CD(Jenkins), 멀티플랫폼 빌드·배포(Windows·Android·iOS·macOS·Linux) |
...
📍 Seoul · Java / Spring · Selenium · LLM APIs · Nexacro · CI/CD
